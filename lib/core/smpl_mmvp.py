...
from lib.data.constants_spin import FOOT_IDS_SMPLL  # # noqa: yapf
from lib.data.constants_spin import FOOT_IDS_SMPLR, JOINT_MAP, JOINT_NAMES
...
class SMPL_MMVP(nn.Module):
    ...
    def __init__(self,
        ...
        baby_mesh = load_mesh(f'{essential_root}' + '/smplify_essential/' +
    ...
    def update_pose(self, body_pose=None):
        ...
        return SMPLMMVPOuput(joints=joints_49,
                             vertices=verts,
                             body_pose=self.body_pose,
                             foot_plane=v_plane,
                             betas=self.betas,
